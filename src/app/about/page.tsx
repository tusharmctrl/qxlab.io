    ...
    <div className="p-5 mt-24 pt-10 md:pt-14">
      <div className="container">
        <div className="space-y-4">
          <h2 className="text-4xl md:text-6xl xl:text-7xl font-semibold text-white text-center">About Us</h2>
          <p className="text-base md:text-xl font-semibold text-white text-center">Automated Digital Customer Experience</p>
        </div>
      </div>
    </div>
    {/* Our Services list */}
