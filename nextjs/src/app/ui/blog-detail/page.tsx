      ...
      <section className="lg:bg-blog-pattern bg-before relative flex flex-shrink-0 flex-grow-0 flex-col items-center justify-center p-5 lg:bg-cover lg:bg-center-right lg:bg-no-repeat">
        <div className="container z-10">
          <div className="mx-auto mb-16 grid min-h-40vmax max-w-5xl place-content-end py-72px text-center">
            <h1 className="text-5xl font-semibold leading-1.4em text-white md:text-6xl lg:text-8xl">Delivering Our First Proof of Concept Reports</h1>
          ...
          <div className="flex flex-wrap items-center justify-between gap-y-5 md:px-5">
            <div className="flex flex-wrap items-center gap-y-5">
              ...
              <ul className="flex flex-wrap items-center gap-3">
                <li>
                  <a href="#" className="block scale-100 rounded-3xl bg-pale-silver px-3 py-1 text-xs text-black transition-all duration-500 hover:scale-110">
                    AI
                  </a>
                </li>
                <li>
      ...
      <section className="mb-8 p-5">
        <div className="container">
          <div className="space-y-8">
            <h2 className="text-center text-26px font-semibold text-white">You may also like</h2>
            <div className="grid grid-cols-1 items-start gap-8 md:grid-cols-2 lg:grid-cols-3">
              <div className="cursor-pointer rounded-2xl shadow-card transition-all duration-300 hover:-translate-y-2 hover:shadow-card-hover">
                ...
                <div className="px-5 pb-5 pt-8">
                  ...
                  <h4 className="my-3 mb-16 text-22px font-semibold text-white transition-all duration-300 hover:text-waterspout">Welcome to QXLab</h4>
                  <a
                    href="#"
              ...
              <div className="cursor-pointer rounded-2xl shadow-card transition-all duration-300 hover:-translate-y-2 hover:shadow-card-hover">
                ...
                <div className="px-5 pb-5 pt-8">
                  ...
                  <h4 className="my-3 mb-16 text-22px font-semibold text-white transition-all duration-300 hover:text-waterspout">
