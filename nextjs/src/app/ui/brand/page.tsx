...
import Uxcx from "@/../public/images/ux-cx.png";
import Perception from "@/../public/images/perception.png";
      ...
      <div className="mt-24 p-5 py-10 lg:py-14">
        <div className="2xl::mb-28 container mb-8 md:mb-10 lg:mb-12">
          <div className="space-y-8">
            <h2 className="text-center text-4xl font-semibold text-white md:text-6xl xl:text-7xl">Who QXi Helps</h2>
            <div className="mx-auto max-w-4xl">
              <p className="text-center text-base font-medium text-white md:text-lg">
                We are delighted to present to you the QXI - our AI-powered insight tool that offers a comprehensive analysis of your business and its
                competitors. Our goal is to empower you with the knowledge you need to stay ahead in your industry.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container space-y-20 lg:space-y-24 2xl:space-y-32">
          <div className="grid grid-cols-1 items-start gap-10 lg:grid-cols-2 lg:gap-24 2xl:gap-40">
            ...
            <div className="relative">
              ...
              <h4 className="mb-3 text-2xl font-semibold text-white md:text-3xl lg:mb-5">UX/CX Researchers</h4>
              <p className="text-sm font-medium leading-2em text-white">
                Save £000s and hours on manual research and insight. QXi is essential for UX/CX researchers, offering immediate insights fromover 400 industry
                and journey specific data points. QXi helps uncover pain points and opportunties ensuring your digital presence is optimized and competitive.
              </p>
            </div>
          </div>
          {/* ==== 02 ==== */}
          <div className="grid grid-cols-1 items-start gap-10 lg:grid-cols-2 lg:gap-24 2xl:gap-40">
            <div className="relative order-2 lg:order-1">
              <div className="relative mb-7 flex h-14 w-14 items-center justify-center lg:mb-10">
                <span className="gradient-marker absolute left-0 top-0 inline-flex h-14 w-14 items-center justify-center rounded-full"></span>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" viewBox="0 0 27 29" fill="none">
                  <path
                    d="M6.17706 22.5132H16.1978V20.0494H6.17706V22.5132ZM6.17706 15.9429H20.8228V13.4791H6.17706V15.9429ZM6.17706 9.37253H20.8228V6.90873H6.17706V9.37253ZM3.18268 28.6729C2.40394 28.6729 1.74477 28.3855 1.20519 27.8106C0.665605 27.2357 0.395813 26.5334 0.395813 25.7036V3.71833C0.395813 2.8886 0.665605 2.18629 1.20519 1.61138C1.74477 1.03648 2.40394 0.749023 3.18268 0.749023H23.8172C24.5959 0.749023 25.2551 1.03648 25.7947 1.61138C26.3343 2.18629 26.6041 2.8886 26.6041 3.71833V25.7036C26.6041 26.5334 26.3343 27.2357 25.7947 27.8106C25.2551 28.3855 24.5959 28.6729 23.8172 28.6729H3.18268ZM3.18268 26.2091H23.8172C23.9358 26.2091 24.0445 26.1565 24.1434 26.0512C24.2422 25.9459 24.2916 25.83 24.2916 25.7036V3.71833C24.2916 3.59196 24.2422 3.47612 24.1434 3.3708C24.0445 3.26551 23.9358 3.21286 23.8172 3.21286H3.18268C3.06408 3.21286 2.95535 3.26551 2.85651 3.3708C2.75768 3.47612 2.70827 3.59196 2.70827 3.71833V25.7036C2.70827 25.83 2.75768 25.9459 2.85651 26.0512C2.95535 26.1565 3.06408 26.2091 3.18268 26.2091Z"
                    fill="#B18D0C"
                  ></path>
                </svg>
              </div>
              <h4 className="mb-3 text-2xl font-semibold text-white md:text-3xl lg:mb-5">Marketers</h4>
              <p className="text-sm font-medium leading-2em text-white">
                Marketers gain valuable insight in to their brands web/app performance metrics, SEO capabilities, and a view on customer sentiment and
                conversation with QXi – immediately bencmarked against their competition. This allows marketers to learn from their industry, optimize
                campaigns, improve ROI, and build a stronger brand image.
              </p>
            </div>
