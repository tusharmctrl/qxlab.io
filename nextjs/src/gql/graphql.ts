...
export type GenericMorph = Author | Blog | BlogTag | CaseStudy | Category | ComponentElementsFeature | ComponentElementsFeatureColumn | ComponentElementsFeatureRow | ComponentElementsFooterSection | ComponentElementsLogos | ComponentElementsNotificationBanner | ComponentElementsPlan | ComponentElementsSocialMediaName | ComponentElementsTestimonial | ComponentLayoutFooter | ComponentLayoutNavbar | ComponentLinksButton | ComponentLinksButtonLink | ComponentLinksLink | ComponentLinksSublinks | ComponentMetaMetadata | ComponentSectionsAboutSection | ComponentSectionsAboutUs | ComponentSectionsBlog | ComponentSectionsBottomActions | ComponentSectionsCard | ComponentSectionsCardCollection | ComponentSectionsCaseStudyDetails | ComponentSectionsContactUs | ComponentSectionsFaq | ComponentSectionsFeatureColumnsGroup | ComponentSectionsFeatureRowsGroup | ComponentSectionsHero | ComponentSectionsHeroProductPage | ComponentSectionsHomeCaseStudy | ComponentSectionsHomeProductInfo | ComponentSectionsLargeVideo | ComponentSectionsLeadForm | ComponentSectionsOurServices | ComponentSectionsPricing | ComponentSectionsProductComingHero | ComponentSectionsProductHowWorks | ComponentSectionsProductWorks | ComponentSectionsRichText | ComponentSectionsServiceHero | ComponentSectionsServicesCard | ComponentSectionsSocialMediaLinks | ComponentSectionsSolutionCard | ComponentSectionsSolutions | ComponentSectionsTest | ComponentSectionsTestimonialsGroup | ComponentSectionsTitle | Global | I18NLocale | LeadFormSubmission | Page | ReviewWorkflowsWorkflow | ReviewWorkflowsWorkflowStage | UploadFile | UsersPermissionsPermission | UsersPermissionsRole | UsersPermissionsUser;
...
export type PageContentSectionsDynamicZone = ComponentElementsFeature | ComponentElementsFeatureColumn | ComponentElementsFeatureRow | ComponentElementsFooterSection | ComponentElementsLogos | ComponentElementsNotificationBanner | ComponentElementsPlan | ComponentElementsSocialMediaName | ComponentElementsTestimonial | ComponentLayoutFooter | ComponentLayoutNavbar | ComponentLinksButton | ComponentLinksButtonLink | ComponentLinksLink | ComponentLinksSublinks | ComponentMetaMetadata | ComponentSectionsAboutSection | ComponentSectionsAboutUs | ComponentSectionsBlog | ComponentSectionsBottomActions | ComponentSectionsCard | ComponentSectionsCardCollection | ComponentSectionsCaseStudyDetails | ComponentSectionsContactUs | ComponentSectionsFaq | ComponentSectionsFeatureColumnsGroup | ComponentSectionsFeatureRowsGroup | ComponentSectionsHero | ComponentSectionsHeroProductPage | ComponentSectionsHomeCaseStudy | ComponentSectionsHomeProductInfo | ComponentSectionsLargeVideo | ComponentSectionsLeadForm | ComponentSectionsOurServices | ComponentSectionsPricing | ComponentSectionsProductComingHero | ComponentSectionsProductHowWorks | ComponentSectionsProductWorks | ComponentSectionsRichText | ComponentSectionsServiceHero | ComponentSectionsServicesCard | ComponentSectionsSocialMediaLinks | ComponentSectionsSolutionCard | ComponentSectionsSolutions | ComponentSectionsTest | ComponentSectionsTestimonialsGroup | ComponentSectionsTitle | Error;
...
export type GlobalDataQuery = (
  ...
  & { cms?: Maybe<(
    ...
    & { global?: Maybe<(
      { __typename?: 'Global' }
      & Pick<Global, 'documentId'>
      & { favicon?: Maybe<(
        { __typename?: 'UploadFile' }
        & Pick<UploadFile, 'url'>
      )>, metadata?: Maybe<(
        { __typename?: 'ComponentMetaMetadata' }
        & Pick<ComponentMetaMetadata, 'id' | 'metaTitle' | 'metaDescription'>
      )>, navbar?: Maybe<(
        { __typename?: 'ComponentLayoutNavbar' }
        & Pick<ComponentLayoutNavbar, 'id'>
        & { logo: (
          { __typename?: 'UploadFile' }
          & Pick<UploadFile, 'url'>
        ), links?: Maybe<Array<Maybe<(
          { __typename?: 'ComponentLinksLink' }
          & Pick<ComponentLinksLink, 'id' | 'newTab' | 'text' | 'url'>
          & { sublinks?: Maybe<Array<Maybe<(
            { __typename?: 'ComponentLinksSublinks' }
            & Pick<ComponentLinksSublinks, 'id' | 'newTab' | 'text' | 'url'>
          )>>> }
        )>>> }
      )>, footer?: Maybe<(
        { __typename: 'ComponentLayoutFooter' }
        & Pick<ComponentLayoutFooter, 'id' | 'smallText'>
        & { logo?: Maybe<(
          { __typename?: 'UploadFile' }
          & Pick<UploadFile, 'url'>
        )>, columns?: Maybe<Array<Maybe<(
          { __typename?: 'ComponentElementsFooterSection' }
          & Pick<ComponentElementsFooterSection, 'id' | 'title'>
          & { links?: Maybe<Array<Maybe<(
            { __typename?: 'ComponentLinksLink' }
            & Pick<ComponentLinksLink, 'id' | 'text' | 'url'>
          )>>> }
        )>>> }
      )> }
    )> }
...
export type StrapiPageDataQuery = (
  { __typename?: 'query_root' }
  & { cms?: Maybe<(
    { __typename?: 'cmsQuery' }
    & { pages: Array<Maybe<(
      { __typename: 'Page' }
      & Pick<Page, 'documentId'>
      & { blogs: Array<Maybe<(
        { __typename?: 'Blog' }
        & Pick<Blog, 'documentId' | 'title' | 'date' | 'slug' | 'blog_content'>
        & { author?: Maybe<(
          { __typename?: 'Author' }
          & Pick<Author, 'name'>
        )>, blog_tags: Array<Maybe<(
          { __typename?: 'BlogTag' }
          & Pick<BlogTag, 'tag_name'>
        )>> }
      )>>, categories: Array<Maybe<(
        { __typename?: 'Category' }
        & Pick<Category, 'documentId' | 'name'>
        & { case_studies: Array<Maybe<(
          { __typename?: 'CaseStudy' }
          & Pick<CaseStudy, 'documentId' | 'title'>
          & { casestudy?: Maybe<(
            { __typename?: 'ComponentSectionsCaseStudyDetails' }
            & Pick<ComponentSectionsCaseStudyDetails, 'id' | 'details'>
          )> }
        )>> }
      )>>, contentSections?: Maybe<Array<Maybe<{ __typename: 'ComponentElementsFeature' } | { __typename: 'ComponentElementsFeatureColumn' } | { __typename: 'ComponentElementsFeatureRow' } | { __typename: 'ComponentElementsFooterSection' } | { __typename: 'ComponentElementsLogos' } | { __typename: 'ComponentElementsNotificationBanner' } | { __typename: 'ComponentElementsPlan' } | { __typename: 'ComponentElementsSocialMediaName' } | { __typename: 'ComponentElementsTestimonial' } | { __typename: 'ComponentLayoutFooter' } | { __typename: 'ComponentLayoutNavbar' } | { __typename: 'ComponentLinksButton' } | { __typename: 'ComponentLinksButtonLink' } | { __typename: 'ComponentLinksLink' } | { __typename: 'ComponentLinksSublinks' } | { __typename: 'ComponentMetaMetadata' } | { __typename: 'ComponentSectionsAboutSection' } | (
        { __typename: 'ComponentSectionsAboutUs' }
        & Pick<ComponentSectionsAboutUs, 'id' | 'title' | 'description'>
        & { about_section?: Maybe<Array<Maybe<(
          { __typename?: 'ComponentSectionsAboutSection' }
          & Pick<ComponentSectionsAboutSection, 'id' | 'label' | 'section_description'>
        )>>> }
      ) | (
        { __typename: 'ComponentSectionsBlog' }
        & Pick<ComponentSectionsBlog, 'id' | 'title'>
      ) | { __typename: 'ComponentSectionsBottomActions' } | { __typename: 'ComponentSectionsCard' } | (
        { __typename: 'ComponentSectionsCardCollection' }
        & Pick<ComponentSectionsCardCollection, 'id'>
        & { card?: Maybe<Array<Maybe<(
          { __typename?: 'ComponentSectionsCard' }
          & Pick<ComponentSectionsCard, 'id' | 'label' | 'title' | 'description'>
          & { more?: Maybe<(
            { __typename?: 'ComponentLinksLink' }
            & Pick<ComponentLinksLink, 'id' | 'url' | 'text' | 'newTab'>
          )> }
        )>>> }
      ) | { __typename: 'ComponentSectionsCaseStudyDetails' } | (
        { __typename: 'ComponentSectionsContactUs' }
        & Pick<ComponentSectionsContactUs, 'id' | 'title'>
        & { image?: Maybe<(
          { __typename?: 'UploadFile' }
          & Pick<UploadFile, 'url'>
        )>, contact_us_btn?: Maybe<(
          { __typename?: 'ComponentLinksButtonLink' }
          & Pick<ComponentLinksButtonLink, 'id' | 'text' | 'url'>
        )> }
      ) | (
        { __typename: 'ComponentSectionsFaq' }
        & Pick<ComponentSectionsFaq, 'id' | 'title'>
        & { upArrow?: Maybe<(
          { __typename?: 'UploadFile' }
          & Pick<UploadFile, 'url' | 'name'>
        )>, downArrow?: Maybe<(
          { __typename?: 'UploadFile' }
          & Pick<UploadFile, 'url' | 'name'>
        )>, faqList?: Maybe<(
          ...
          & { features?: Maybe<Array<Maybe<(
            { __typename?: 'ComponentElementsFeatureColumn' }
            & Pick<ComponentElementsFeatureColumn, 'id' | 'title' | 'description'>
            & { arrow?: Maybe<(
              { __typename?: 'UploadFile' }
              & Pick<UploadFile, 'url' | 'name'>
            )> }
      ...
      ) | { __typename: 'ComponentSectionsFeatureColumnsGroup' } | { __typename: 'ComponentSectionsFeatureRowsGroup' } | (
        { __typename: 'ComponentSectionsHero' }
        & Pick<ComponentSectionsHero, 'id' | 'title' | 'label' | 'description'>
        & { buttons?: Maybe<Array<Maybe<(
          { __typename?: 'ComponentLinksButtonLink' }
          & Pick<ComponentLinksButtonLink, 'id' | 'text' | 'newTab' | 'type' | 'url'>
        )>>> }
      ) | (
        { __typename: 'ComponentSectionsHeroProductPage' }
        & Pick<ComponentSectionsHeroProductPage, 'id' | 'title' | 'description'>
        & { logo?: Maybe<(
          { __typename?: 'UploadFile' }
          & Pick<UploadFile, 'name' | 'url'>
        )>, productImage: (
          ...
          { __typename?: 'ComponentLinksButtonLink' }
          & Pick<ComponentLinksButtonLink, 'text' | 'id' | 'newTab' | 'url' | 'type'>
        )> }
      ) | (
        { __typename: 'ComponentSectionsHomeCaseStudy' }
        & Pick<ComponentSectionsHomeCaseStudy, 'id' | 'title' | 'description'>
        & { case_study_btn?: Maybe<(
          { __typename?: 'ComponentLinksButtonLink' }
          & Pick<ComponentLinksButtonLink, 'id' | 'text' | 'type' | 'url'>
        )>, image?: Maybe<(
          { __typename?: 'UploadFile' }
          & Pick<UploadFile, 'url'>
        )> }
        ...
        { __typename: 'ComponentSectionsHomeProductInfo' }
        & Pick<ComponentSectionsHomeProductInfo, 'id' | 'title' | 'description'>
        & { product_image?: Maybe<(
          { __typename?: 'UploadFile' }
          & Pick<UploadFile, 'url'>
        )> }
      ) | { __typename: 'ComponentSectionsLargeVideo' } | { __typename: 'ComponentSectionsLeadForm' } | (
        { __typename: 'ComponentSectionsOurServices' }
        & Pick<ComponentSectionsOurServices, 'id' | 'title' | 'description'>
        & { services_cards?: Maybe<Array<Maybe<(
          { __typename?: 'ComponentSectionsServicesCard' }
          & Pick<ComponentSectionsServicesCard, 'id' | 'name' | 'description'>
          & { icon: Array<Maybe<(
            { __typename?: 'UploadFile' }
            & Pick<UploadFile, 'url'>
          )>> }
        ...
        { __typename: 'ComponentSectionsProductComingHero' }
        & Pick<ComponentSectionsProductComingHero, 'id' | 'description'>
        & { logo?: Maybe<(
          { __typename?: 'UploadFile' }
          & Pick<UploadFile, 'url' | 'name'>
        )>, button?: Maybe<(
          { __typename?: 'ComponentLinksButtonLink' }
          & Pick<ComponentLinksButtonLink, 'id' | 'text' | 'url' | 'type' | 'newTab'>
        )> }
      ) | { __typename: 'ComponentSectionsProductHowWorks' } | (
        { __typename: 'ComponentSectionsProductWorks' }
        & Pick<ComponentSectionsProductWorks, 'id' | 'title'>
        & { howItWorks?: Maybe<(
          { __typename?: 'ComponentSectionsProductHowWorks' }
          & Pick<ComponentSectionsProductHowWorks, 'id'>
          & { image?: Maybe<(
            { __typename?: 'UploadFile' }
            & Pick<UploadFile, 'name' | 'url'>
          )>, worksFeature?: Maybe<(
        ...
        { __typename: 'ComponentSectionsServiceHero' }
        & Pick<ComponentSectionsServiceHero, 'title' | 'description'>
        & { button?: Maybe<(
          { __typename?: 'ComponentLinksButtonLink' }
          & Pick<ComponentLinksButtonLink, 'id' | 'newTab' | 'text' | 'type' | 'url'>
        )> }
      ) | { __typename: 'ComponentSectionsServicesCard' } | (
        { __typename: 'ComponentSectionsSocialMediaLinks' }
        & { social_media_name?: Maybe<Array<Maybe<(
          { __typename?: 'ComponentElementsSocialMediaName' }
          & Pick<ComponentElementsSocialMediaName, 'id' | 'name'>
          & { icon?: Maybe<(
            { __typename?: 'UploadFile' }
            & Pick<UploadFile, 'url'>
          )> }
        ...
        { __typename: 'ComponentSectionsSolutions' }
        & Pick<ComponentSectionsSolutions, 'id' | 'title' | 'description'>
        & { solution_cards?: Maybe<Array<Maybe<(
          { __typename?: 'ComponentSectionsSolutionCard' }
          & Pick<ComponentSectionsSolutionCard, 'id' | 'image_position' | 'solution_name' | 'solution_description'>
          & { label?: Maybe<(
            { __typename?: 'UploadFile' }
            & Pick<UploadFile, 'url'>
          )>, solution_image?: Maybe<(
            { __typename?: 'UploadFile' }
            & Pick<UploadFile, 'url'>
          )> }
        )>>> }
      ) | { __typename: 'ComponentSectionsTest' } | { __typename: 'ComponentSectionsTestimonialsGroup' } | { __typename: 'ComponentSectionsTitle' } | { __typename: 'Error' }>>> }
    )>>, blogs: Array<Maybe<(
      { __typename?: 'Blog' }
      & Pick<Blog, 'documentId' | 'title' | 'date' | 'slug' | 'blog_content'>
      & { author?: Maybe<(
